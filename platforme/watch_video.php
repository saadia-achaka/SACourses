...
if(isset($_POST['like_content'])){
   ...
   if($user_id != ''){
      ...
      $content_id = filter_var($content_id, FILTER_SANITIZE_SPECIAL_CHARS);
...
if(isset($_POST['add_comment'])){
   ...
   if($user_id != ''){
      ...
      $comment_box = filter_var($comment_box, FILTER_SANITIZE_SPECIAL_CHARS);
      $content_id = $_POST['content_id'];
      $content_id = filter_var($content_id, FILTER_SANITIZE_SPECIAL_CHARS);
...
<?php
   if(isset($_POST['edit_comment'])){
      ...
      $edit_id = filter_var($edit_id, FILTER_SANITIZE_SPECIAL_CHARS);
...
<section class="watch-video">
   ...
   <div class="video-details">
      <video src="../uploaded/<?= $fetch_content['video']; ?>" class="video" poster="../uploaded/<?= $fetch_content['thumb']; ?>" controls autoplay></video>
