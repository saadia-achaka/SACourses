...
// Récupérer les questions du quiz pour la catégorie "Réseau et Sécurit"
$category_id = 2; // ID de la catégorie Réseau et Sécurité (changez-le si nécessaire)
...
<head>
    ...
    <title>Quiz - Réseau et Sécurit</title>
...
<section class="quiz">
    <h1>Quiz sur Réseau et Sécurit</h1>
    <!-- Formulaire de soumission du quiz -->
    <form action="submit_quizRese.php" method="POST">
